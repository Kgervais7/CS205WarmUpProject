...
class EnglishBoard:
    ...
    '''The Move method first checks to see if the specified move is legal. If it is not legal, a variety of exceptions are 
    thrown. If the move passes all the specified tests, then it is accepted and updated on the baord.'''
